...
10. [Segurança (nuxt-security)](#segurança-nuxt-security)
...
O template usa o módulo [`nuxt-security`](https://nuxt-security.vercel.app) com headers de segurança configurados por padrão.
